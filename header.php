...
<html <?php language_attributes(); ?>>
    ...
    <body>
        ...
        <header>
            <h1 id="site-title" itemscope itemtype="http://schema.org/Organization"><a href="<?php echo home_url(); ?>" rel="nofollow"><?php bloginfo('name'); ?></a></h1>
            <nav id="main-nav" style="display: none;" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
